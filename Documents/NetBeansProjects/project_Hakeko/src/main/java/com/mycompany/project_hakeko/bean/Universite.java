...
public class Universite implements Serializable {
    ...
    public Universite(Long id, String nom, String description, String email, Long tel, String login, String password, String numAutorisation, String raisonSocial, List<Inscription> inscriptions, List<AnonceUniversite> anonceUniversites, Ville ville, List<UniversiteDevice> universiteDevices) {
        this.id = id;
        this.nom = nom;
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + Objects.hashCode(this.numAutorisation);
        hash = 79 * hash + Objects.hashCode(this.raisonSocial);
        hash = 79 * hash + Objects.hashCode(this.inscriptions);
        hash = 79 * hash + Objects.hashCode(this.anonceUniversites);
        hash = 79 * hash + Objects.hashCode(this.ville);
        hash = 79 * hash + Objects.hashCode(this.universiteDevices);
        return hash;
    }
    ...
    public String toString() {
        return "Universite{" + "id=" + id + ", nom=" + nom + ", description=" + description + ", email=" + email + ", tel=" + tel + ", login=" + login + ", password=" + password + ", numAutorisation=" + numAutorisation + ", raisonSocial=" + raisonSocial + ", inscriptions=" + inscriptions + ", anonceUniversites=" + anonceUniversites + ", ville=" + ville + ", universiteDevices=" + universiteDevices + '}';
    }
